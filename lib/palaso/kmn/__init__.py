...
_modifiers = {
    ...
    'RAlt'      : (0x80, 0xE038, 0x04, 0x99, 0x01A5),
    'AltGr'     : (0x80, 0x00, 0x04, 0x00, 0xFF),
...
_rawkeys = {
    ...
    'K_LSHIFT'   : (0xFFE1, 0xFFE1, 0x2A, 0xA0, "Left Shift", ""),
    'K_SHIFT'   : (0xFFE1, 0xFFE1, 0x80, 0x10, "Shift", ""),
    'K_CONTROL' : (0xFFE3, 0xFFE3, 0x1D, 0xA2, "Ctrl", "Right Ctrl"),
