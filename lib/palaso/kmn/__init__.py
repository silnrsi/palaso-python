...
# 3 - MSKLC Ext Keyname
_rawkeys = {
    'K_SPACE'   : (0x20, 0x39, "Space", ""),
    'K_QUOTE'   : (0x27, 0x28, "Apostrophe", ""),
    'K_0'       : (0x30, 0x0B, "", ""),
    'K_1'       : (0x31, 0x02, "", ""),
    'K_2'       : (0x32, 0x03, "", ""),
    'K_3'       : (0x33, 0x04, "", ""),
    ...
    'K_Y'       : (0x59, 0x15, "", ""),
    'K_Z'       : (0x5A, 0x2C, "", ""),
    'K_BKQUOTE' : (0x60, 0x01, "Esc", ""),
    'K_COMMA'   : (0x2C, 0x33, "", ""),
    'K_HYPHEN'  : (0x2D, 0x0C, "", ""),
    'K_PERIOD'  : (0x2E, 0x34, "", ""),
    'K_SLASH'   : (0x2F, 0x35, "", "Num /"),
    'K_COLON'   : (0x3A, 0x27, "", ""),
    'K_EQUAL'   : (0x3D, 0x0D, "", ""),
    'K_LBRKT'   : (0x5B, 0x1A, "", ""),
    'K_BKSLASH' : (0x5C, 0x2B, "", ""),
    'K_RBRKT'   : (0x5D, 0x1B, "", ""),
    'K_BKSP'    : (0xFF08, 0x0E, "Backspace", ""),
    'K_TAB'     : (0xFF09, 0x0F, "Tab", ""),
    'K_ENTER'   : (0xFF0D, 0x1C, "Enter", "Num Enter"),
    'K_PAUSE'   : (0xFF13, 0x59, "", ""),
    'K_SCROLL'  : (0xFF14, 0x46, "Scroll Lock", "Break"),
    'K_ESC'     : (0xFF1B, 0x01, "", ""),
    'K_HOME'    : (0xFF50, 0x47, "Num 7", "Home"),
    'K_LEFT'    : (0xFF51, 0x4B, "Num 4", "Left"),
    'K_UP'      : (0xFF52, 0x48, "Num 8", "Up"),
    'K_RIGHT'   : (0xFF53, 0x4D, "Num 6", "Right"),
    'K_DOWN'    : (0xFF54, 0x50, "Num 2", "Down"),
    'K_PGUP'    : (0xFF55, 0x49, "Num 9", "Page Up"),
    'K_PGDN'    : (0xFF56, 0x51, "Num 3", "Page Down"),
    'K_END'     : (0xFF57, 0x4F, "Num 1", "End"),
    'K_INS'     : (0xFF63, 0x52, "Num 0", "Insert"),
    'K_NUMLOCK' : (0xFF7F, 0x45, "Pause", "Num Lock"),
    'K_NPSTAR'  : (0xFFAA, 0x37, "Num *", "Prnt Scrn"),
    'K_NPPLUS'  : (0xFFAB, 0x4E, "Num +", ""),
    'K_NPMINUS' : (0xFFAD, 0x4A, "Num -", ""),
    'K_NPDOT'   : (0xFFAE, 0x53, "Num Del", "Delete"),
    'K_NPSLASH' : (0xFFAF, 0x35, "", "Num /"),
    'K_NP0'     : (0xFFB0, 0x52, "Num 0", "Insert"),
    'K_NP1'     : (0xFFB1, 0x4F, "Num 1", "End"),
    'K_NP2'     : (0xFFB2, 0x50, "Num 2", "Down"),
    'K_NP3'     : (0xFFB3, 0x51, "Num 3", "Page Down"),
    'K_NP4'     : (0xFFB4, 0x4B, "Num 4", "Left"),
    'K_NP5'     : (0xFFB5, 0x4C, "Num 5", ""),
    'K_NP6'     : (0xFFB6, 0x4D, "Num 6", "Right"),
    'K_NP7'     : (0xFFB7, 0x47, "Num 7", "Home"),
    'K_NP8'     : (0xFFB8, 0x48, "Num 8", "Up"),
    'K_NP9'     : (0xFFB9, 0x49, "Num 9", "Page Up"),
    'K_F1'      : (0xFFBE, 0x3B, "F1", ""),
    'K_F2'      : (0xFFBF, 0x3C, "F2", ""),
    'K_F3'      : (0xFFC0, 0x3D, "F3", ""),
    'K_F4'      : (0xFFC1, 0x3E, "F4", ""),
    ...
    'K_F8'      : (0xFFC5, 0x42, "F8", ""),
    'K_F9'      : (0xFFC6, 0x43, "F9", ""),
    'K_F10'     : (0xFFC7, 0x44, "F10", ""),
    'K_F11'     : (0xFFC8, 0x57, "F11", ""),
    'K_F12'     : (0xFFC9, 0x58, "F12", ""),
    'K_F13'     : (0xFFCA, 0x7C, "F13", ""),
    'K_F14'     : (0xFFCB, 0x7D, "F14", ""),
    'K_F15'     : (0xFFCC, 0x7E, "F15", ""),
    'K_F16'     : (0xFFCD, 0x7F, "F16", ""),
    'K_F17'     : (0xFFCE, 0x80, "F17", ""),
    'K_F18'     : (0xFFCF, 0x81, "F18", ""),
    'K_F19'     : (0xFFD0, 0x82, "F19", ""),
    'K_F20'     : (0xFFD1, 0x83, "F20", ""),
    'K_F21'     : (0xFFD2, 0x84, "F21", ""),
    'K_F22'     : (0xFFD3, 0x85, "F22", ""),
    'K_F23'     : (0xFFD4, 0x86, "F23", ""),
    'K_F24'     : (0xFFD5, 0x87, "F24", ""),
    'K_SHIFT'   : (0xFFE1, 0x2A, "Shift", ""),
    'K_CONTROL' : (0xFFE3, 0x1D, "Ctrl", "Right Ctrl"),
    'K_CAPS'    : (0xFFE5, 0x3A, "Caps Lock", ""),
    'K_ALT'     : (0xFFE9, 0x38, "Alt", "Right Alt"),
    'K_oE2'     : (0x3C, 0x00, "", ""),
    'K_LWIN'    : (0x00, 0xE05B, "", "Left Windows"),
    'K_RWIN'    : (0x00, 0xE05C, "", "Right Windows"),
    'K_APP'     : (0x00, 0xE05D, "", "Application")
}
...
def item_to_char(item) :
    res = item_to_key(item)
    if len(res) > 2 and res[0] == '[' and res[-1] == ']' :
        words = re.split(r'\s+', res[1:-1].strip())
...
def keysym_klcinfo(sym) :
    ...
    if re.match(r'\[[^\]]+\]$', sym) :
        ...
        vkey = words[-1]
        item, sc, kn, ekn = _rawkeys[words[-1]]
