...
setup(name='palaso',
      ...
      packages=['', 'palaso', 'palaso.collation', 'palaso.kmn', 'palaso.sfm', 'palaso.teckit', 'palaso.text', 'palaso.font', 'palaso.unicode', 'palaso.contrib', 'palaso.contrib.freetype', 'palaso.contrib.freetype.ft_enums'],
      ext_modules = ext,
      cmdclass = cmd,
